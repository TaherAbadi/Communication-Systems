function [y] = Channel(B,N0,A,signal,Rb,d )
sigma = sqrt(N0*B);
t = 0: 0.001:0.1;
...
% if (d>0)
%     chnlp_withnoise = conv(chnlp_withnoise, abs(t(2)-t(1))*1/d*exp(-t/d));
%     chnlp_withoutnoise = conv(chnlp_withoutnoise, abs(t(2)-t(1))*1/d*exp(-t/d));
% else
%     chnlp_withnoise = chnlp_withnoise;
%     chnlp_withoutnoise = chnlp_withoutnoise;
% end
